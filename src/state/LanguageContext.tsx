...
const TEXT = {
  ...
  zh: {
    ...
    guestUser: "游客",
    createOrJoinHome: "创建或加入一个小朝廷",
    signInToCreateHome: "请先登录，再创建或加入小朝廷",
    displayName: "用户名",
    saveName: "保存用户名",
    save: "保存",
    homeNameSaved: "小朝廷名称已保存。",
    couldNotSaveHomeName: "无法保存小朝廷名称。",
    removeMember: "移除同僚",
    confirmRemoveMember: "确定要把 {name} 移出这个小朝廷吗？",
    memberRemoved: "同僚已移除。",
    couldNotRemoveMember: "无法移除同僚。",
    startHome: "创建小朝廷",
    startHomeHint: "创建一个小朝廷，或使用邀请码加入。",
    homeName: "小朝廷名称",
    createHome: "创建小朝廷",
    inviteCode: "邀请码",
    join: "加入",
    joinAnotherHome: "加入另一个小朝廷",
    copy: "复制",
    members: "同僚",
    owner: "管理员",
    member: "同僚",
    ...
    chooseMember: "选择同僚",
    comments: "说明",
    noHomeRequest: "请先登录并创建或加入小朝廷，再提交申请。",
    noHomeReport: "请先登录并创建或加入小朝廷，再提交举报。",
